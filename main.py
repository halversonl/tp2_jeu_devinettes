"""
Crée par Leo Halverson le 23 septembre 2022
Code qui génère un chiffre située entre les bornes déterminés par
l'usager qui doit ensuite deviner ce chiffre.
"""
...
def jeu():
    """
    Fonction qui contient le jeu dans son entierté afin de rendre très facile
    de le boucler.
    :return:
    """
    # Choix de bornes
